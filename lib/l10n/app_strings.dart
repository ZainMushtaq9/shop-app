...
/// Displays single language dynamically based on state.
class AppStrings {
  AppStrings._();
  ...
  // ─── App Info ───
  static String get appName => _isUrdu ? 'حساب کرو' : 'HisaabKaro';
  ...
  static String get productName => _isUrdu ? 'مصنوعات کا نام' : 'Product Name';
  ...
  static String get stockQuantity => _isUrdu ? 'اسٹاک تعداد' : 'Stock';
  static String get minStockAlert => _isUrdu ? 'کم از کم اسٹاک الرٹ' : 'Min Stock Alert';
  ...
  static String get receivePayment => _isUrdu ? 'ادائیگی وصول کریں' : 'Receive Payment';
  ...
  static String get viewBill => _isUrdu ? 'بل دیکھیں' : 'View Bill';
  static String get sendPdf => _isUrdu ? 'پی ڈی ایف بھیجیں' : 'Send PDF';
  ...
  static String get makePayment => _isUrdu ? 'ادائیگی کریں' : 'Make Payment';
  static String get addPurchase => _isUrdu ? 'خریداری شامل کریں' : 'Add Purchase';
  ...
  static String get paymentMade => _isUrdu ? 'ادائیگی کر دی' : 'Payment Made';
  static String get returnToSupplier => _isUrdu ? 'سپلائر کو واپسی' : 'Return to Supplier';

  // ─── Ledger Table Headers ───
  static String get date => _isUrdu ? 'تاریخ' : 'Date';
  static String get description => _isUrdu ? 'تفصیل' : 'Description';
  static String get debit => _isUrdu ? 'ڈیبٹ (ڈار)' : 'Debit (DR)';
  static String get credit => _isUrdu ? 'کریڈٹ (کر)' : 'Credit (CR)';
  static String get balance => _isUrdu ? 'بیلنس' : 'Balance';
  static String get amount => _isUrdu ? 'رقم' : 'Amount';

  // ─── Money Flow ───
  static String get moneyToReceive => _isUrdu ? 'ملنے والی رقم' : 'Money I Will Receive';
  static String get moneyToPay => _isUrdu ? 'دینے والی رقم' : 'Money I Must Pay';
  ...
  static String get agingAnalysis => _isUrdu ? 'بقایا رقم تجزیہ' : 'Aging Analysis';
  ...
  static String get viewAllCustomers => _isUrdu ? 'تمام گاہک دیکھیں' : 'View All Customers';
  static String get viewAllSuppliers => _isUrdu ? 'تمام سپلائر دیکھیں' : 'View All Suppliers';
  ...
  static String get changesUploaded => _isUrdu ? 'تبدیلیاں اپ لوڈ ہو گئیں' : 'Changes Uploaded';
  static String get conflictDetected => _isUrdu ? 'دو جگہ تبدیلی ہوئی' : 'Changed In 2 Places';
  ...
  static String get shareOnWhatsapp => _isUrdu ? 'واٹس ایپ پر بھیجیں' : 'Share on WhatsApp';
  ...
  // ─── Backup ───
  static String get backupNow => _isUrdu ? 'ابھی بیک اپ لیں' : 'Backup Now';
  static String get restoreBackup => _isUrdu ? 'بیک اپ سے بحال کریں' : 'Restore Backup';
  ...
  static String get electricity => _isUrdu ? 'بجلی بل' : 'Electricity';
